...
class mainMenuScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.audio('buttonSound', ['assets/audio/magedu_button.mp3', 'magedu_button.ogg']);
    }
...
class preloadGame extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.audio('bgSound', ['assets/audio/FastFeelBananaPeel-320bit.mp3', 'assets/audio/FastFeelBananaPeel-320bit.ogg']);
        this.load.audio('gameOverSound', ['assets/audio/mixkit-sad-game-over-trombone-471.mp3', 'mixkit-sad-game-over-trombone-471.ogg']);
        this.load.audio('jumpSound', ['assets/audio/tramppa34_jump-sound.mp3', 'tramppa34_jump-sound.ogg']);
        this.load.audio('treeDestructionSound', ['assets/audio/inspectorj_destruction-wooden-a.mp3', 'inspectorj_destruction-wooden-a.ogg']);
        this.load.audio('buttonSound', ['assets/audio/magedu_button.mp3', 'magedu_button.ogg']);
        this.load.audio('forestSound', ['assets/audio/jonasrocha_amazon-florest.mp3', 'jonasrocha_amazon-florest.ogg']);
    }
...
class playGame extends Phaser.Scene {
    ...
    create() {
        ...
        this.treeDestructionSound = this.sound.add('treeDestructionSound');
        this.buttonSound = this.sound.add('buttonSound');
        ...
        this.bgSound.play(bgSoundConfiguration());
        this.forestSound.play(bgSoundConfiguration());
    ...
    createTextLife(object) {
        return object.add.text(game.config.width - 70, 16, '♥♥♥', { fontFamily: 'MV Boli Bold', fontSize: '35px', fill: '#fc2003' });
    }
...
function treeColider(player, tree) {
    ...
    this.treeDestructionSound.play(treeDestructionSoundConfiguration());
    ...
    this.lifeText.setText(lifesText);
...
function treeDestructionSoundConfiguration() {
    return {
        mute: false,
        volume: 0.5,
        rate: 0.5,
        detune: getRandom(0, 1200),
        seek: 0,
        loop: false,
        delay: 0
    }
